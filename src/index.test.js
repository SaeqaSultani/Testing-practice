...
const reverseString = require('./functions/reverse-string.js');
...
describe('Subtract', () => {
  it('should return the subtract of tow number', () => {
    const calculator = new Calculator();
...
describe('Multiply', () => {
  it('should return the multiply of tow number', () => {
    const calculator = new Calculator();
...
describe('Divide', () => {
  it('should return the divide of tow number', () => {
    const calculator = new Calculator();
